...
function initConflictFlowchart() {
    ...
    const connections = [];
    // OPTIMIZATION: Use a Map for O(1) step lookup instead of O(n) array search in the nested loop.
    // This reduces complexity from O(n^2) to O(n) where n is the number of steps.
