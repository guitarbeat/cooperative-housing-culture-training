...
// Optimization: Pre-defined simulation outcomes for O(1) lookup
...
function initCommunicationSimulator() {
    ...
    simulateButton.addEventListener('click', function() {
        ...
        // Optimization: Use hash map lookup instead of nested if/else for O(1) performance
        let results = SIMULATION_OUTCOMES[scenarioKey]?.[style] || '';
